...
|final_hieryy_num|Hierarchical number given based on the final position of a coach.  This column has the following values:<br><ul><li>1: Head coach</li><li>2: Coordinator (Offensive/Defensive)</li><li>3: Position coach (Offensive/Defensive)</li><li>-1: Not a qualified coach</li></ul>|
